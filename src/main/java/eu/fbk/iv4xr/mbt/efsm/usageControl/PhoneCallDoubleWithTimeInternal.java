...
public class PhoneCallDoubleWithTimeInternal  implements EFSMProvider{
	...
	public EFSMState ClosingCall2 = new EFSMState("ClosingCall2");
...
//		phoneCallEFSMBuilder.withTransition(Calling1and2, Calling1, t18);	
		...
		t18_1.setGuard(new EFSMGuard(enoughCredit_and_notEnoughCredit2_and_IsChargingTimeCall1_and_IsCharginTimeCall2));
		...
		// t18_2: ClosingCall2 - noCredit for 2  -> Calling1
		EFSMTransition t18_2 = new EFSMTransition();
		t18_2.setOp(new EFSMOperation(timeCall1Reset));
		Var<Enum> t18_2Out = new Var<Enum>("action", uconEvents.RE_EVAL_DENY);
		t18_2.setInParameter(in_no_input);
		t18_2.setOutParameter(new EFSMParameter(t18_2Out));
		phoneCallEFSMBuilder.withTransition(ClosingCall2, Calling1, t18_2);
		...
		t22.setOp(new EFSMOperation(charge, timeCall2Reset));
