...
public class DoubleLess extends CompareOp  {

	/**
	 * 
	 */
	private static final long serialVersionUID = -9166655064089491105L;

	public DoubleLess(Exp<?> parameter1, Exp<?> parameter2) {
	...
	public boolean equalsUpToValue(Object o) {
		...
		if (o instanceof DoubleLess) {
			DoubleLess is = (DoubleLess) o;
